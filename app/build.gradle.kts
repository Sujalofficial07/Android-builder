...
android {
    namespace = "com.android.builder"

    defaultConfig {
        applicationId = "com.android.builder"
...
kapt {
    arguments {
        arg("eventBusIndex", "com.android.builder.events.AppEventsIndex")
    }
}
...
dependencies {
    ...
    // Build tooling API impl before app
